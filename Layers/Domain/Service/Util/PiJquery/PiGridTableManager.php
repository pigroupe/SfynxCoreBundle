...
class PiGridTableManager extends PiJqueryExtension
{
    ...
    */
    ...
    protected function gridSimple($options = null)
    {
        ...
        $remove       = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."remove.png");
        $select_all   = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."select_all.png");
        $select_none  = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."select_none.png");
        $print        = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."print.png");
        $export       = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."export.png");
        $export_pdf   = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."export_pdf.png");
        $export_csv   = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."export_csv.png");
        $export_xls   = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."export_xls.png");
        $copy         = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."copy.png");
        $export_all   = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."export_all.png");
        $archive      = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."archive.png");
        $penabled     = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."penabled.png");
        $pdisable     = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."pdisable.png");
        $action       = $this->container->get('templating.helper.assets')->getUrl($this->container->getParameter('sfynx.template.theme.layout.admin.grid.img')."action.png");
