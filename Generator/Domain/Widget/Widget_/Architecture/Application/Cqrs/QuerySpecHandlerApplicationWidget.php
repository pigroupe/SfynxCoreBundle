...
/**
 * Cqrs Query SpecHandler Application Widget
 ...
 */
class QuerySpecHandlerApplicationWidget extends AbstractWidget implements WidgetInterface
{
    /** @var string */
    const TAG = 'widget_cqrs_query_validator_specification';
    ...
    {
        return 'QuerySpecHandlerApplicationWidget is an extendable code parser for object-oriented PHP-Projects to generate SpecHandler component';
    }
...
EOT;
    ...
    {
        $templater = new Templater_\Architecture\Application\Cqrs\QuerySpecHandler\Templater($this);
        $templater->apply();

        return [
            WidgetInterface::KEY_TAG => Templater_\Architecture\Application\Cqrs\QuerySpecHandler\Templater::TAG,
