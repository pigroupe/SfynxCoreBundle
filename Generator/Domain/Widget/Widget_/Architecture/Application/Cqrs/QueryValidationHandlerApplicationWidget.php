...
/**
 * Cqrs Query ValidationHandler Application Widget
 ...
 */
class QueryValidationHandlerApplicationWidget extends AbstractWidget implements WidgetInterface
{
    /** @var string */
    const TAG = 'widget_cqrs_query_validator_validation';
    ...
    {
        return 'QueryValidationHandlerApplicationWidget is an extendable code parser for object-oriented PHP-Projects to generate ValidationHandler component';
    }
...
EOT;
    ...
    {
        $templater = new Templater_\Architecture\Application\Cqrs\QueryValidationHandler\Templater($this);
        $templater->apply();
        
        return [
            WidgetInterface::KEY_TAG => Templater_\Architecture\Application\Cqrs\QueryValidationHandler\Templater::TAG,
