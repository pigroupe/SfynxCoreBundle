<?php
namespace Sfynx\CoreBundle\Generator\Domain\Templater\Templater_\Architecture\Application\Cqrs\QueryValidationHandler;
 ...
 * @package    Domain
 * @subpackage TemplaterTemplater_\Architecture\Application\Cqrs\QueryValidationHandler
 *
...
{
    /** @var string */
    const TAG = 'templater_archi_app_cqrs_queryvalidationhandler';
    ...
    public static function scriptList(string $template): array
    {
        return [
            '0' => [
                'Application\Cqrs',
                __DIR__ . "/Resources/${template}/QueryValidationHandler.php",
            ]
        ];
    }
