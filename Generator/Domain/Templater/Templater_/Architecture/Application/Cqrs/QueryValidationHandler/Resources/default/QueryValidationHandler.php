...
use Sfynx\CoreBundle\Layers\Application\Query\Validation\ValidationHandler\Generalisation\AbstractQueryValidationHandler;
 ...
 */
class <?php echo $templater->getTargetClassname(); ?> extends AbstractQueryValidationHandler
{
    /** @var bool */
     ...
     * @return void
     */
    protected function initConstraints(QueryInterface $query): void
    {
        $this
