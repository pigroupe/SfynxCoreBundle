 ...
 * @since      2015-02-16
 */
class HandlerOrmFactoryPass implements HandlerPassInterface
{
    /** @var string */
    protected $entity;
    /** @var string */
    ...
    {
        $commandQuerybuilder = [];
        if ($container->hasParameter("{$this->alias}.repository.{$this->entity}.orm.command.querybuilder")) {
            $commandQuerybuilder = $container->getParameter("{$this->alias}.repository.{$this->entity}.orm.command.querybuilder");
        }
        $queryQuerybuilder = [];
        if ($container->hasParameter("{$this->alias}.repository.{$this->entity}.orm.query.querybuilder")) {
            $queryQuerybuilder = $container->getParameter("{$this->alias}.repository.{$this->entity}.orm.query.querybuilder");
        }
            ...
            $container
                ->setDefinition("{$this->alias}.factory.{$this->entity}", new Definition(
                        ...
                        [
                            ...
                            $container->getParameter("{$this->alias}.repository.{$this->entity}.orm.command.class"),
                            $container->getParameter("{$this->alias}.repository.{$this->entity}.orm.query.class"),
